Pod::Spec.new do |s|
  ...
  s.source   = { :git => 'http://git.jimubox.com/BBAE/iOS-toB-SourceCode.git', :tag => 'v1.0.12', :submodules => true}
...
EOS
  ...
  s.subspec 'Vendor' do |ss|
    ...
    ss.subspec 'JMSToastView' do |sss|
      ...
      sss.private_header_files = 'jimustock_iOS_BBAE/bbaestock/jimustockFoundation/jimustockFoundation/Vendor/ToastView/*.h'
      ...
      sss.ios.dependency 'JimustockFoundation/Vendor/JMSCustomBaseViews'
      sss.ios.dependency 'JimustockFoundation/Constant'
    end
  end
  ...
  s.subspec 'View' do |ss|
    ...
    ss.ios.dependency 'JimustockFoundation/Category'
